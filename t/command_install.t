...
is $nodebrew->run('install', ['v0.4.0']), "v0.4.0 is already installed\n";
like $nodebrew->run('install', ['v0.4.1']), qr/v0.4.1 is not found/;

$nodebrew->run('install', ['io@1.0.0']);
